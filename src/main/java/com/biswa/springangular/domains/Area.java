...
public class Area implements Serializable{
	...
	//Not auto generated because we are coping the data from devinfo table, number of time we create the table 
	//we need to configure area nid and parent area nid
	@Id	
...
//	private List<PlanningSchedule> planningSchedules;
...
/*	public List<PlanningSchedule> getPlanningSchedules() {
		return planningSchedules;
	}

	public void setPlanningSchedules(List<PlanningSchedule> planningSchedules) {
		this.planningSchedules = planningSchedules;
	}*/
